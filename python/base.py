...
class Data(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        self.batch_size_syn = self.batch_size - self.batch_size_real
    ...
    def forward(self, bottom, top):
        ...
        self.data_real = np.array(read_lmdb(self.real_image_folder, self.real_idx))
        self.label_real = np.array(read_lmdb(self.real_label_folder, self.real_idx))
        ...
        self.data = np.row_stack((self.data_real, self.data_syn))
        self.label = np.row_stack((self.label_real, self.label_syn))
